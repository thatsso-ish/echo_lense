...
const ProjectTypeStep: React.FC<ProjectTypeStepProps> = ({ formData, setFormData }) => {
  return (
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        {projectTypes.map((type) => (
          ...
          >
            ...
            <p className="text-gray-400 text-sm">Starting from ${type.basePrice.toLocaleString()}</p>
          </button>
        ))}
      </div>
    </div>
